...
import com.yourssu.assignmentblog.domain.user.domain.UserRoleChecker
...
class UserService(
    ...
    fun getUsers(
        ...
        UserRoleChecker.checkRoleWithRepository(userRepository, authInfo.email) {
            val users: List<User> =
            ...
            return@checkRoleWithRepository GetUsersResponseDto(userVOList)
        }
}
